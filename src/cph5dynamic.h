...
class CPH5Dynamic {
    ...
    template<typename T>
    static bool memberAdderIf(const H5::DataType &h5type, CPH5CompType *fill, std::string name) {
    ...
    static void recurseComptype(const H5::CompType &h5type, CPH5CompType *fill);
...
template<> H5T_sign_t CPH5Dynamic::getH5Sign<int8_t>() { return H5T_SGN_2; }
template<> H5T_sign_t CPH5Dynamic::getH5Sign<int16_t>() { return H5T_SGN_2; }
template<> H5T_sign_t CPH5Dynamic::getH5Sign<int32_t>() { return H5T_SGN_2; }
template<> H5T_sign_t CPH5Dynamic::getH5Sign<int64_t>() { return H5T_SGN_2; }
template<> H5T_sign_t CPH5Dynamic::getH5Sign<uint8_t>() { return H5T_SGN_NONE; }
template<> H5T_sign_t CPH5Dynamic::getH5Sign<uint16_t>() { return H5T_SGN_NONE; }
template<> H5T_sign_t CPH5Dynamic::getH5Sign<uint32_t>() { return H5T_SGN_NONE; }
template<> H5T_sign_t CPH5Dynamic::getH5Sign<uint64_t>() { return H5T_SGN_NONE; }

    
template<>
bool CPH5Dynamic::memberAdderIf<float>(const H5::DataType &h5type, CPH5CompType *fill, std::string name) {
...
template<>
bool CPH5Dynamic::memberAdderIf<double>(const H5::DataType &h5type, CPH5CompType *fill, std::string name) {
...
template<>
bool CPH5Dynamic::arrayAddIf<float>(H5::DataType &h5type, CPH5CompType *fill, std::string name, int nElements) {
    if (h5type.getSize() == sizeof(float)) {
...
template<>
bool CPH5Dynamic::arrayAddIf<double>(H5::DataType &h5type, CPH5CompType *fill, std::string name, int nElements) {
    if (h5type.getSize() == sizeof(double)) {
